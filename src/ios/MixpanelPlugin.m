...
-(void)init:(CDVInvokedUrlCommand*)command;
{
    ...
    Mixpanel* mixpanelInstance = [Mixpanel sharedInstanceWithToken:token launchOptions:nil trackCrashes:NO automaticPushTracking:NO optOutTrackingByDefault:NO];
